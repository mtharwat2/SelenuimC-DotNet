...
namespace SmartPatrolFramework.Helpers
{
    public class HtmlTableHelper
    {
        ...
        private static ColumnSpecialValue GetControl(IWebElement columnValue)
        {
            ...
            if (columnValue.FindElements(By.TagName("span")).Count > 0)
            {
                columnSpecialValue = new ColumnSpecialValue
                {
                    ElementCollection = columnValue.FindElements(By.TagName("span")),
                    ControlType = "span"
                };
            }
            if (columnValue.FindElements(By.TagName("div")).Count > 0)
            {
                columnSpecialValue = new ColumnSpecialValue
                {
                    ElementCollection = columnValue.FindElements(By.TagName("div")),
                    ControlType = "div"
                };
            }
